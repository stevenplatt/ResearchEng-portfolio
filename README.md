...
ResearchEng Portfolio is a flat file website written entirely in HTML and CSS. It is designed to be easy to modify and mintain, while also including specific pages for research, which may not be included in a standard developer portfolio template.
